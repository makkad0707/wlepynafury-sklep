// --- 1. BAZA PRODUKTÓW ---
const products = [
    { id: 1, name: "Zdałam za ósmym, proszę o dystans", price: 14.99, image: "img/za osmym 194 x 79.png", inStock: true, bgColor: "#fdfdff", description: "Kiedy boisz się nie tylko o swoje życie ale też innych", material: "Folia standardowa", size: "19,4 cm x 7,9 cm" },
    { id: 2, name: "Tatuś kupił", price: 14.99, image: "img/144szer x 79wys_tatuskupil.png", inStock: true, bgColor: "#fdfdff", description: "Chwała ojcu i jego pieniądzom", material: "Folia standardowa", size: "14,4 cm x 7,9 cm" },
    { id: 3, name: "Byłam Passanger Princess", price: 14.99, image: "img/BYŁAM PASSANGER PRINCESS 194 x 79.png", inStock: true, bgColor: "#fdfdff", description: "Urodzona pasażerką, zmuszona do bycia kierowcą", material: "Folia standardowa", size: "19,4 cm x 7,9 cm" },
    { id: 4, name: "WYŁUDZONE Z VATU", price: 14.99, image: "img/szer194_wys_79_WYŁUDZONE Z VAT-U.png", inStock: false, bgColor: "#fdfdff", description: "Pochwal się skąd na to miałeś (miejmy nadzieje, że nikt z urzędu nie zobaczy)", material: "Folia standardowa", size: "19,4 cm x 7,9 cm" }
